...
GLOBAL_LIST_INIT_TYPED(quirk_blacklist, /list/datum/quirk, list(
	...
	//list(/datum/quirk/numb, /datum/quirk/selfaware), // SPLURT EDIT REMOVAL - Suggestion from the community
	...
	list(/datum/quirk/psionic_dampener, /datum/quirk/telepathic), // SPLURT EDIT - Addition
