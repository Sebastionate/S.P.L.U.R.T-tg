...
/obj/item/organ/eyes/proc/generate_body_overlay(obj/item/bodypart/head/my_head)
	...
	var/mutable_appearance/eye_left = mutable_appearance(eye_icon, "[eye_icon_state]_l", -eyes_layer) // SPLURT EDIT - Eyes layer
	var/mutable_appearance/eye_right = mutable_appearance(eye_icon, "[eye_icon_state]_r", -eyes_layer) // SPLURT EDIT - Eyes layer
...
/obj/item/organ/eyes/proc/get_emissive_overlays(mutable_appearance/eye_left, mutable_appearance/eye_right, atom/spokesman)
	...
	if(emissive_effect)
		return_list += emissive_appearance(eye_left.icon, eye_left.icon_state, spokesman, eye_left.layer, alpha = eye_left.alpha, effect_type = emissive_effect)
		return_list += emissive_appearance(eye_right.icon, eye_right.icon_state, spokesman, eye_right.layer, alpha = eye_right.alpha, effect_type = emissive_effect)
	else
		return_list += emissive_blocker(eye_left.icon, eye_left.icon_state, spokesman, eye_left.layer, alpha = eye_left.alpha)
		return_list += emissive_blocker(eye_right.icon, eye_right.icon_state, spokesman, eye_right.layer, alpha = eye_right.alpha)
...
/obj/item/organ/eyes/proc/get_eyelid_overlays(mutable_appearance/eye_left, mutable_appearance/eye_right, obj/item/bodypart/head/my_head)
	...
	if ((!parent.appears_alive() && !HAS_TRAIT(parent, TRAIT_UNDEAD)) || HAS_TRAIT(parent, TRAIT_KNOCKEDOUT)) // SPLURT EDIT - Undead eyes
