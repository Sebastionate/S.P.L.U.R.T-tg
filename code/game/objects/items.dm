...
/obj/item/update_greyscale()
	...
	if(greyscale_config_worn_taur_big)
		worn_icon_taur_big = SSgreyscale.GetColoredIconByType(greyscale_config_worn_taur_big, greyscale_colors)
	// SKYRAT EDIT ADD END
...
/obj/item/proc/compare_zone_to_item_slot(zone)
	switch(slot_flags)
		...
		if(ITEM_SLOT_HEAD, ITEM_SLOT_EARS_LEFT, ITEM_SLOT_EARS_RIGHT, ITEM_SLOT_EARS, ITEM_SLOT_NECK) // SPLURT EDIT - Extra Inventory
