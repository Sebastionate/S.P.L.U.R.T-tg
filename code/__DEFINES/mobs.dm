...
/// SPLURT EDIT - Extra ears (behind the primary ears slot)
#define EARS_EXTRA_LAYER 16
/// Shoes layer
#define SHOES_LAYER 17
/// SPLURT EDIT - Wrists (between shoes and gloves)
#define WRISTS_LAYER 18
/// Gloves layer
#define GLOVES_LAYER 19
	/// Layer for bodyparts that should appear above every other bodypart - Currently only used for hands
	#define BODYPARTS_HIGH_LAYER 19.5
/// ID card layer
#define ID_LAYER 20
// BUBBER EDIT ADDITION BEGIN
#define BANDAGE_LAYER 21
#define ASS_LAYER_FRONT 21.9
...
#define UNIFORM_LAYER 26
	...
	#define UNDER_UNIFORM_LAYER 26.1
// BUBBER EDIT ADDITION BEGIN
...
#define DAMAGE_LAYER 28
	...
	#define FRONT_MUTATIONS_LAYER 28.9
// SPLURT EDIT - Separate underwear/socks/bra/shirt standing overlays (under uniform/damage, above eyes/body)
